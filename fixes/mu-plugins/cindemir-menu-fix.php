...
final class Cindemir_Menu_Fix {
	...
	private static function burger_css_tag() {
		return '<style id="cindemir-menu-fix-burger" data-cfasync="false">'
			...
			. 'background:#f4f2ec!important;background-color:#f4f2ec!important;'
			. 'background-image:linear-gradient(180deg,#f8f6f0 0%,#f1efe8 100%)!important;'
			. 'box-shadow:-12px 0 32px rgba(18,34,34,.16)!important;'
			. 'border-left:1px solid rgba(31,74,74,.08)!important;'
			. 'transform:none!important;-webkit-transform:none!important;'
			. '}'
			. '.av-burger-overlay-scroll::before{'
			. 'content:""!important;display:block!important;position:absolute!important;'
			. 'top:0!important;left:0!important;right:0!important;height:3px!important;'
			. 'background:linear-gradient(90deg,#1f4a4a,#3a7a6a)!important;z-index:2!important}'
			. '.av-burger-overlay-bg{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;min-height:100vh!important;z-index:3!important;opacity:.38!important;background:#0e1c1c!important;cursor:pointer!important;'
			...
			. 'padding:76px 20px 40px!important;height:auto!important;min-height:0!important;'
			...
			. 'font-size:18px!important;font-weight:400!important;letter-spacing:.015em!important;'
			. 'line-height:1.3!important;padding:13px 12px!important;'
			...
			/* Language chips in one compact row */
			. '#av-burger-menu-ul > li.cindemir-lang-row{'
			. 'display:block!important;margin-top:22px!important;padding-top:18px!important;'
			. 'border-top:1px solid rgba(31,74,74,.12)!important;'
			. 'list-style:none!important}'
			...
			. 'padding:7px 11px!important;font-size:11px!important;font-weight:600!important;'
			. 'font-family:"Segoe UI",system-ui,-apple-system,sans-serif!important;'
			. 'letter-spacing:.06em!important;text-transform:uppercase!important;'
			. 'color:#1f4a4a!important;background:rgba(255,255,255,.55)!important;'
			. 'border:1px solid rgba(31,74,74,.14)!important;border-radius:999px!important;'
			...
			. 'background:#fff!important;border-color:rgba(31,74,74,.28)!important}'
			. '#av-burger-menu-ul .cindemir-lang-flag,'
			. '#av-burger-menu-ul img.avia_wpml_flag,'
			. '#av-burger-menu-ul .wpml-ls-flag{'
			. 'width:16px!important;height:11px!important;object-fit:cover!important;'
			. 'border-radius:2px!important;display:inline-block!important;flex:0 0 auto!important;'
			. 'opacity:.95!important}'
			/* Soften burger X while open — match brand, not harsh white */
	...
	private static function burger_js_tag() {
		...
		return '<script id="cindemir-menu-fix-burger-js" data-nowprocket nowprocket data-no-minify="1" data-cfasync="false" data-pagespeed-no-defer>'
			...
			. 's.style.setProperty("width","min(300px, 88vw)","important");'
			...
			. 's.style.setProperty("background","#f4f2ec","important");'
			. 's.style.setProperty("background-color","#f4f2ec","important");'
			. 's.style.setProperty("background-image","linear-gradient(180deg,#f8f6f0 0%,#f1efe8 100%)","important");'
			. 's.style.setProperty("box-shadow","-12px 0 32px rgba(18,34,34,.16)","important");'
			. 's.style.setProperty("border-left","1px solid rgba(31,74,74,.08)","important");'
			. 's.style.setProperty("transform","none","important");'
			. '}'
			. 'var bg=o.querySelector(".av-burger-overlay-bg");'
			. 'if(bg){bg.style.setProperty("background","#0e1c1c","important");bg.style.setProperty("opacity","0.38","important");}'
